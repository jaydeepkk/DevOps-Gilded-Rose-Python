...
class GoldenMasterTest(unittest.TestCase):
    ...
    def test_update_items(self):
        ...
        self.assertEqual(
            ...
            "Conjured Mana Cake, 2, 4]"  # Conjured item should degrade by 2
        )
        ...
        self.assertEqual(
            ...
            "Backstage passes to a TAFKAL80ETC concert, -6, 0, Conjured Mana Cake, -8, 0]"  # Conjured item should degrade by 4 after sell_in
        )
